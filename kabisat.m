...
% Last Modified by GUIDE v2.5 05-Apr-2021 14:36:24
...
function kabisat_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = kabisat_OutputFcn(~, ~, handles) 
...
function tahun_CreateFcn(hObject, ~, ~)
% hObject    handle to tahun (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --- Executes on button press in periksa.
function periksa_Callback(~, ~, handles)
% hObject    handle to periksa (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
